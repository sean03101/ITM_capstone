package com.example.myapplication.ui.a_page.page1.page51;
 ...
 */
public class a_page51_1 extends Fragment {
    ...
    public static a_page51_1 newInstance(String param1, String param2) {
        a_page51_1 fragment = new a_page51_1();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        databaseReference.orderByChild("study_category_low").equalTo("해외영업/무역영업").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
