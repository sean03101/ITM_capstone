package com.example.myapplication.ui.a_page.page1.page41;
 ...
 */
public class a_page41_1 extends Fragment {
    ...
    public static a_page41_1 newInstance(String param1, String param2) {
        a_page41_1 fragment = new a_page41_1();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup rootview = (ViewGroup) inflater.inflate(R.layout.d_page4, container, false);
        ...
        databaseReference.orderByChild("study_category_low").equalTo("그래픽디자인/CG").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
