...
public class Parsingmeeting extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        meetAddData_previous = (MeetAddData) previous_intent123.getSerializableExtra("Data Object");
    ...
    private AdapterView.OnItemClickListener itemClickListenerOfList = new AdapterView.OnItemClickListener()
    {
        public void onItemClick(AdapterView<?> adapterView, View clickedView, int pos, long id) {
            ...
            meetAddData.setStudy_category_high(meetAddData_previous.getStudy_category_high());
            meetAddData.setStudy_category_low(meetAddData_previous.getStudy_category_low());

            meetAddData.setStudy_company(selected_item);


            meetAddData.setStudy_ishab(meetAddData_previous.isStudy_ishab());

            meetAddData.setStudy_explain(meetAddData_previous.getStudy_explain());
            meetAddData.setStudy_explain2(meetAddData_previous.getStudy_explain2());



            Intent intent2 = new Intent(Parsingmeeting.this, Addmeeting.class);
            intent2.putExtra("Data Object", meetAddData);
