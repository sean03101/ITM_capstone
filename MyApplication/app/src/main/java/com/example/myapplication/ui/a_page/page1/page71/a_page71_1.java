 ...
 */
public class a_page71_1 extends Fragment {
    ...
    public static a_page71_1 newInstance(String param1, String param2) {
        a_page71_1 fragment = new a_page71_1();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        databaseReference.orderByChild("study_category_low").equalTo("자동차/조선/기계").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
