 ...
 */
public class a_page81_5 extends Fragment {
    ...
    public static a_page81_5 newInstance(String param1, String param2) {
        a_page81_5 fragment = new a_page81_5();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        databaseReference.orderByChild("study_category_low").equalTo("환경/플랜트").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
