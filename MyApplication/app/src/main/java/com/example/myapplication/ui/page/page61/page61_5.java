 ...
 */
public class page61_5 extends Fragment {
    ...
    public static page61_5 newInstance(String param1, String param2) {
        page61_5 fragment = new page61_5();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        databaseReference.orderByChild("study_category_low").equalTo("광고영업").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
