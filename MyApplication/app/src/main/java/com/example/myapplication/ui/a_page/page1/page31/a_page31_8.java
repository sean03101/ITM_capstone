 ...
 */
public class a_page31_8 extends Fragment {
    ...
    public static a_page31_8 newInstance(String param1, String param2) {
        a_page31_8 fragment = new a_page31_8();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        databaseReference.orderByChild("study_category_low").equalTo("QA/테스터/검증").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
