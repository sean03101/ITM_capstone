 ...
 */
public class a_page31_7 extends Fragment {
    ...
    public static a_page31_7 newInstance(String param1, String param2) {
        a_page31_7 fragment = new a_page31_7();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        databaseReference.orderByChild("study_category_low").equalTo("UI/UX").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
