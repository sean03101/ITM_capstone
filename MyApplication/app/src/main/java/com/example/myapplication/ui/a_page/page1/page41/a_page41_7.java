 ...
 */
public class a_page41_7 extends Fragment {
    ...
    public static a_page41_7 newInstance(String param1, String param2) {
        a_page41_7 fragment = new a_page41_7();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        databaseReference.orderByChild("study_category_low").equalTo("기타").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
