 ...
 */
public class a_page81_4 extends Fragment {
    ...
    public static a_page81_4 newInstance(String param1, String param2) {
        a_page81_4 fragment = new a_page81_4();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        databaseReference.orderByChild("study_category_low").equalTo("소방/안전").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
