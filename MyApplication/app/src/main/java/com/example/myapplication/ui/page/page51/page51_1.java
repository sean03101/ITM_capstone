package com.example.myapplication.ui.page.page51;
 ...
 */
public class page51_1 extends Fragment {
    ...
    public static page51_1 newInstance(String param1, String param2) {
        page51_1 fragment = new page51_1();
