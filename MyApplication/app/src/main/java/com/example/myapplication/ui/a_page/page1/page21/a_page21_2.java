 ...
 */
public class a_page21_2 extends Fragment {
    ...
    public static a_page21_2 newInstance(String param1, String param2) {
        a_page21_2 fragment = new a_page21_2();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        databaseReference.orderByChild("study_category_low").equalTo("홍보/PR").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
