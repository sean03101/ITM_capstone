 ...
 */
public class a_page81_2 extends Fragment {
    ...
    public static a_page81_2 newInstance(String param1, String param2) {
        a_page81_2 fragment = new a_page81_2();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        databaseReference.orderByChild("study_category_low").equalTo("시공/현장/감리/공무").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
