 ...
 */
public class a_page31_4 extends Fragment {
    ...
    public static a_page31_4 newInstance(String param1, String param2) {
        a_page31_4 fragment = new a_page31_4();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        databaseReference.orderByChild("study_category_low").equalTo("DBA/데이터베이스").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
