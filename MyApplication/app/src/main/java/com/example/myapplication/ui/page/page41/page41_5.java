package com.example.myapplication.ui.page.page41;
 ...
 */
public class page41_5 extends Fragment {
    ...
    public static page41_5 newInstance(String param1, String param2) {
        page41_5 fragment = new page41_5();
