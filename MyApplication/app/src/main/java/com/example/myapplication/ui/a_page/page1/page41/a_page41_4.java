 ...
 */
public class a_page41_4 extends Fragment {
    ...
    public static a_page41_4 newInstance(String param1, String param2) {
        a_page41_4 fragment = new a_page41_4();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        databaseReference.orderByChild("study_category_low").equalTo("광고/시각디자인").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
