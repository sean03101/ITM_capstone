 ...
 */
public class a_page31_5 extends Fragment {
    ...
    public static a_page31_5 newInstance(String param1, String param2) {
        a_page31_5 fragment = new a_page31_5();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        databaseReference.orderByChild("study_category_low").equalTo("네트워크/서버/보안").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
