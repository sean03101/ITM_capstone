 ...
 * Use the {@link a_page31_1#newInstance} factory method to
 * create an instance of this fragment.
 */
public class a_page31_1 extends Fragment {
    ...
    public static a_page31_1 newInstance(String param1, String param2) {
        a_page31_1 fragment = new a_page31_1();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        databaseReference.orderByChild("study_category_low").equalTo("IT/디지털").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
