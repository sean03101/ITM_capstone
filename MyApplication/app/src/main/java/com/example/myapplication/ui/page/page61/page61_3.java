package com.example.myapplication.ui.page.page61;
 ...
 */
public class page61_3 extends Fragment {
    ...
    public static page61_3 newInstance(String param1, String param2) {
        page61_3 fragment = new page61_3();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        databaseReference.orderByChild("study_category_low").equalTo("IT/솔루션/기술영업").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
