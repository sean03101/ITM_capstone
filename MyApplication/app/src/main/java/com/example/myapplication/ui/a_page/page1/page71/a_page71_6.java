 ...
 */
public class a_page71_6 extends Fragment {
    ...
    public static a_page71_6 newInstance(String param1, String param2) {
        a_page71_6 fragment = new a_page71_6();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        databaseReference.orderByChild("study_category_low").equalTo("통신기술/네트워크구축").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
