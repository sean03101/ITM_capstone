 ...
 */
public class a_page71_3 extends Fragment {
    ...
    public static a_page71_3 newInstance(String param1, String param2) {
        a_page71_3 fragment = new a_page71_3();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        databaseReference.orderByChild("study_category_low").equalTo("화학/에너지/환경").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
