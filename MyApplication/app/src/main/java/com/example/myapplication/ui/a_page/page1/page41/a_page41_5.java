 ...
 */
public class a_page41_5 extends Fragment {
    ...
    public static a_page41_5 newInstance(String param1, String param2) {
        a_page41_5 fragment = new a_page41_5();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        databaseReference.orderByChild("study_category_low").equalTo("의류/패션/잡화 디자인").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
