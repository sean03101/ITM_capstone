 ...
 */
public class a_page41_6 extends Fragment {
    ...
    public static a_page41_6 newInstance(String param1, String param2) {
        a_page41_6 fragment = new a_page41_6();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        databaseReference.orderByChild("study_category_low").equalTo("전시/공간디자인").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
