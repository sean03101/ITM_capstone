 ...
 */
public class page61_6 extends Fragment {
    ...
    public static page61_6 newInstance(String param1, String param2) {
        page61_6 fragment = new page61_6();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        databaseReference.orderByChild("study_category_low").equalTo("아웃바운드/인바운드").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
