package com.example.myapplication.ui.page.page81;
 ...
 */
public class page81_2 extends Fragment {
    ...
    public static page81_2 newInstance(String param1, String param2) {
        page81_2 fragment = new page81_2();
