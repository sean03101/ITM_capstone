 ...
 */
public class a_page41_2 extends Fragment {
    ...
    public static a_page41_2 newInstance(String param1, String param2) {
        a_page41_2 fragment = new a_page41_2();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        databaseReference.orderByChild("study_category_low").equalTo("제품/산업디자인").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
