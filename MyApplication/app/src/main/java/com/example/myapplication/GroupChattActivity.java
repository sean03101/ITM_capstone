...
public class GroupChattActivity extends AppCompatActivity {
        ...
        sendBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(TextUtils.isEmpty(message)){
                    Toast.makeText(GroupChattActivity.this, "Can't send empty message", Toast.LENGTH_SHORT).show();
                }
                else {
                    sendMessage(message);
                }
    ...
    private void showImageImportDialog() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(GroupChattActivity.this);
    ...
    private void sendImageMessage() {
        ...
        pd.setTitle("기다려 주십시오");
        pd.setMessage("이미지를 보내는 중입니다");
        ...
        ref.child(groupId).child("Messages")
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        adapterGroupChat = new AdapterGroupChat(GroupChattActivity.this, groupChatList);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if(id == R.id.action_add_participant){
            ...
            intent.putExtra("myGroupRole", myGroupRole);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode == 438 && resultCode==RESULT_OK && data != null && data.getData()!=null){
            ...
            if(!checker.equals("image")){
                ...
                ProgressDialog pd = new ProgressDialog(this);
                pd.setTitle("기다려 주십시오");
                pd.setMessage("파일을 보내는중입니다");
                pd.setCanceledOnTouchOutside(false);
                pd.show();

                DatabaseReference userMessageKeyRef = FirebaseDatabase.getInstance().getReference("Groups")
                .child(groupId).child("Messages").child(timestamp).push();
                ...
                Log.i("dataOnchange", String.valueOf(uploadTask));
                ...
                Toast.makeText(this,"Nothing Selected, Error...", Toast.LENGTH_SHORT);
            }
        }
    }
            ...
            case CAMERA_REQUEST_CODE:
                if(grantResults.length > 0){
                    ...
                    if(cameraAccepted && writeStorageAccepted){
                        ...
                        Toast.makeText(this,"카메라 허용 접근이 필요합니다.", Toast.LENGTH_SHORT).show();
                    }
            ...
            case STORAGE_REQUEST_CODE:
                if(grantResults.length>0){
                    ...
                    if(writeStorageAccepted){
                        ...
                        Toast.makeText(this,"스토리지 허용 접근이 필요합니다.", Toast.LENGTH_SHORT).show();
                    }
                }
                break;
        }
