 ...
 */
public class a_page51_2 extends Fragment {
    ...
    public static a_page51_2 newInstance(String param1, String param2) {
        a_page51_2 fragment = new a_page51_2();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        databaseReference.orderByChild("study_category_low").equalTo("수출입").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
