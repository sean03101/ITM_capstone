...
class AddCVModel {
    ...
    public AddCVModel(String study_name,String study_category_high, String study_category_low, String study_company,
                      String study_explain, String study_explain1, String study_primary) {
