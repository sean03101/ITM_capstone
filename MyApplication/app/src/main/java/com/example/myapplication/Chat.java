...
public class Chat extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if(item.getItemId()== R.id.main_create_group_option){
            Intent createIntent = new Intent(Chat.this, CreateGroupActivity.class);
        ...
        builder.setPositiveButton("Create", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                if(TextUtils.isEmpty(groupName)){
                    Toast.makeText(Chat.this, "Please write Group Name", Toast.LENGTH_SHORT).show();
                }
                else{
    ...
    private void SendUserToFindFriendsActivity(){
        Intent findFriendsIntent = new Intent(Chat.this, FindFriendsActivity.class);
