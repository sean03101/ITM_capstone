package com.example.myapplication.ui.a_page.page1;
...
import com.example.myapplication.ADetailActivity;
...
public class a_RecyclerViewAdapter extends RecyclerView.Adapter<a_RecyclerViewAdapter.CustomViewHolder> {


    private ArrayList<a_RecyclerViewModel> arrayList;
    private Context context;

    public a_RecyclerViewAdapter(ArrayList<a_RecyclerViewModel> arrayList, Context context) {
    ...
    public CustomViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.recycler_a_box, parent, false);
    ...
    public void onBindViewHolder(@NonNull @NotNull CustomViewHolder holder, int position) {
        ...
        holder.recyclerview_studybox_high.setText(arrayList.get(position).getA_name());
        holder.recyclerview_studybox_middle.setText(arrayList.get(position).getStudy_company());
        holder.recyclerview_studybox_low_1.setText(arrayList.get(position).getStudy_category_high());
        holder.recyclerview_studybox_low_4.setText(arrayList.get(position).getStudy_category_low());

        holder.itemView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(v.getContext(), ADetailActivity.class);
                intent.putExtra("Study Primary Key3", arrayList.get(position).getA_primary());
