 ...
 */
public class page61_7 extends Fragment {
    ...
    public static page61_7 newInstance(String param1, String param2) {
        page61_7 fragment = new page61_7();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        databaseReference.orderByChild("study_category_low").equalTo("CS관리/CRM").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
