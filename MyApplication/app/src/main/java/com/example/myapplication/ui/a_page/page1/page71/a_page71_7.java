 ...
 */
public class a_page71_7 extends Fragment {
    ...
    public static a_page71_7 newInstance(String param1, String param2) {
        a_page71_7 fragment = new a_page71_7();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        databaseReference.orderByChild("study_category_low").equalTo("바이오/제약/식품").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
