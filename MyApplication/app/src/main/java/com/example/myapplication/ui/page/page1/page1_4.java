package com.example.myapplication.ui.page.page1;
 ...
 */
public class page1_4 extends Fragment {
    ...
    public static page1_4 newInstance(String param1, String param2) {
        page1_4 fragment = new page1_4();
