 ...
 */
public class page61_1 extends Fragment {
    ...
    public static page61_1 newInstance(String param1, String param2) {
        page61_1 fragment = new page61_1();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        databaseReference.orderByChild("study_category_low").equalTo("제품/서비스영업").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
