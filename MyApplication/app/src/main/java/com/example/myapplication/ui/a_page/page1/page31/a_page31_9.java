 ...
 */
public class a_page31_9 extends Fragment {
    ...
    public static a_page31_9 newInstance(String param1, String param2) {
        a_page31_9 fragment = new a_page31_9();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        databaseReference.orderByChild("study_category_low").equalTo("게임").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
