 ...
 */
public class a_page71_2 extends Fragment {
    ...
    public static a_page71_2 newInstance(String param1, String param2) {
        a_page71_2 fragment = new a_page71_2();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        databaseReference.orderByChild("study_category_low").equalTo("반도체/디스플레이").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
