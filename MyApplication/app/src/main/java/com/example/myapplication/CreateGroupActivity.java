            ...
            storageReference.putFile(image_uri)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            Task<Uri> p_uriTaks = taskSnapshot.getStorage().getDownloadUrl();
                            while(!p_uriTaks.isSuccessful());
                            Uri p_downloadUri = p_uriTaks.getResult();
                            if(p_uriTaks.isSuccessful()){
                ...
                ref1.child(g_timestamp).child("Participants").child(firebaseAuth.getUid()).setValue(hashMap1)
                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                            ...
                            public void onSuccess(Void aVoid) {
                                ...
                                PreferenceManager.setString(mContext, "groupId" , g_timestamp);
