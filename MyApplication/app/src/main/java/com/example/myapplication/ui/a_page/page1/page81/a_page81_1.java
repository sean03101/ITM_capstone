 ...
 */
public class a_page81_1 extends Fragment {
    ...
    public static a_page81_1 newInstance(String param1, String param2) {
        a_page81_1 fragment = new a_page81_1();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        databaseReference.orderByChild("study_category_low").equalTo("건축/설계/인테리어").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
