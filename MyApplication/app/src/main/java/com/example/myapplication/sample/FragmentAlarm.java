...
import com.example.myapplication.viewpagerr.VIewpager.viewpagerr1;
import com.example.myapplication.viewpagerr.VIewpager.viewpagerr2;
import com.example.myapplication.viewpagerr.VIewpager.viewpagerr3;
import com.example.myapplication.viewpagerr.VIewpager.viewpagerr4;
import com.example.myapplication.viewpagerr.VIewpager.viewpagerr5;
import com.example.myapplication.viewpagerr.VIewpager.viewpagerr6;
import com.example.myapplication.viewpagerr.VIewpager.viewpagerr7;
import com.example.myapplication.viewpagerr.VIewpager.viewpagerr8;
...
public class FragmentAlarm extends Fragment {
    ...
    private ArrayList<a_RecyclerViewModel> arrayList, arrayList1, arrayList2, arrayList3, arrayList4, arrayList5, arrayList6, arrayList7;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
                ...
                switch (a){
                            ...
                            databaseReference.orderByChild("study_category_high").equalTo("경영/사무").addListenerForSingleValueEvent(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull @NotNull DataSnapshot snapshot) {
                                    ...
                                    for(DataSnapshot snapshot1 : snapshot.getChildren()){ //반복문으로 데이터 리스트 추출
                                        a_RecyclerViewModel recylcerViewModel = snapshot1.getValue(a_RecyclerViewModel.class); //만들어뒀던 유저 객체에 데이터 담음
                    ...
                    case 2 :
                        if(String.valueOf(dataSnapshot.child("checkbox_2").getValue()) == "true"){
                            ...
                            adapter1 = new a_RecyclerViewAdapter(arrayList1, getActivity());
                    ...
                    case 3:
                        if(String.valueOf(dataSnapshot.child("checkbox_3").getValue()) == "true"){
                            ...
                            adapter2 = new a_RecyclerViewAdapter(arrayList2, getActivity());
                    ...
                    case 4:
                        if(String.valueOf(dataSnapshot.child("checkbox_4").getValue()) == "true"){
                            ...
                            adapter3 = new a_RecyclerViewAdapter(arrayList3, getActivity());
                    ...
                    case 5:
                        if(String.valueOf(dataSnapshot.child("checkbox_5").getValue()) == "true"){
                            ...
                            adapter4 = new a_RecyclerViewAdapter(arrayList4, getActivity());
                    ...
                    case 6:
                        if(String.valueOf(dataSnapshot.child("checkbox_6").getValue()) == "true"){
                            ...
                            adapter5 = new a_RecyclerViewAdapter(arrayList5, getActivity());
                    ...
                    case 7:
                        if(String.valueOf(dataSnapshot.child("checkbox_7").getValue()) == "true"){
                            ...
                            adapter6 = new a_RecyclerViewAdapter(arrayList6, getActivity());
                    ...
                    case 8:
                        if(String.valueOf(dataSnapshot.child("checkbox_8").getValue()) == "true"){
                            ...
                            adapter7 = new a_RecyclerViewAdapter(arrayList7, getActivity());
        ...
        Button.OnClickListener onClickListener = new Button.OnClickListener() {
            ...
            public void onClick(View v) {
                switch (v.getId()) {
                    case R.id.button1:
                        Intent intent = new Intent(getActivity(), viewpagerr1.class);
                        startActivity(intent);
                        break;

                    case R.id.button2:
                        Intent intent2 = new Intent(getActivity(), viewpagerr2.class);
                        startActivity(intent2);
                        break;

                    case R.id.button3:
                        Intent intent3 = new Intent(getActivity(), viewpagerr3.class);
                        startActivity(intent3);
                        break;
                    case R.id.button4:
                        Intent intent4 = new Intent(getActivity(), viewpagerr4.class);
                        startActivity(intent4);
                        break;
                    case R.id.button5:
                        Intent intent5 = new Intent(getActivity(), viewpagerr5.class);
                        startActivity(intent5);
                        break;
                    case R.id.button6:
                        Intent intent6 = new Intent(getActivity(), viewpagerr6.class);
                        startActivity(intent6);
                        break;
                    case R.id.button7:
                        Intent intent7 = new Intent(getActivity(), viewpagerr7.class);
                        startActivity(intent7);
                        break;
                    case R.id.button8:
                        Intent intent8 = new Intent(getActivity(), viewpagerr8.class);
