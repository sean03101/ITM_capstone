...
package com.example.myapplication.ui.page.page71;
 ...
 */
public class page71_5 extends Fragment {
    ...
    public static page71_5 newInstance(String param1, String param2) {
        page71_5 fragment = new page71_5();
