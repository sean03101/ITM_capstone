package com.example.myapplication.ui.page.page31;
 ...
 * Use the {@link page31_3#newInstance} factory method to
 * create an instance of this fragment.
 */
public class page31_3 extends Fragment {
    ...
    public static page31_3 newInstance(String param1, String param2) {
        page31_3 fragment = new page31_3();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = (RecyclerView) rootview.findViewById(R.id.recyclerView_studylist); //아디연결
