 ...
 */
public class page61_2 extends Fragment {
    ...
    public static page61_2 newInstance(String param1, String param2) {
        page61_2 fragment = new page61_2();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        databaseReference.orderByChild("study_category_low").equalTo("금융/보험영업").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
