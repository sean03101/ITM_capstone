 ...
 * Use the {@link a_page31_2#newInstance} factory method to
 * create an instance of this fragment.
 */
public class a_page31_2 extends Fragment {
    ...
    public static a_page31_2 newInstance(String param1, String param2) {
        a_page31_2 fragment = new a_page31_2();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        databaseReference.orderByChild("study_category_low").equalTo("웹프로그램").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
