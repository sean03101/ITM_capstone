 ...
 */
public class a_page41_3 extends Fragment {
    ...
    public static a_page41_3 newInstance(String param1, String param2) {
        a_page41_3 fragment = new a_page41_3();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        databaseReference.orderByChild("study_category_low").equalTo("캐릭터/애니메이션").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
