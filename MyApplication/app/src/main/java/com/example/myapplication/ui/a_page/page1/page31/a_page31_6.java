 ...
 */
public class a_page31_6 extends Fragment {
    ...
    public static a_page31_6 newInstance(String param1, String param2) {
        a_page31_6 fragment = new a_page31_6();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        databaseReference.orderByChild("study_category_low").equalTo("기획/PM").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
