...
package com.example.myapplication.ui.a_page.page1.page71;
 ...
 */
public class a_page71_5 extends Fragment {
    ...
    public static a_page71_5 newInstance(String param1, String param2) {
        a_page71_5 fragment = new a_page71_5();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        databaseReference.orderByChild("study_category_low").equalTo("기계설계/CAP/CAM").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
