 ...
 */
public class a_page71_4 extends Fragment {
    ...
    public static a_page71_4 newInstance(String param1, String param2) {
        a_page71_4 fragment = new a_page71_4();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        databaseReference.orderByChild("study_category_low").equalTo("전기/전자/제어").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
