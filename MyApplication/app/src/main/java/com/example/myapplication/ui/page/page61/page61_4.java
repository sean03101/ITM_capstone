 ...
 */
public class page61_4 extends Fragment {
    ...
    public static page61_4 newInstance(String param1, String param2) {
        page61_4 fragment = new page61_4();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        databaseReference.orderByChild("study_category_low").equalTo("영업관리/지원/기획").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
