 ...
 */
public class a_page31_10 extends Fragment {
    ...
    public static a_page31_10 newInstance(String param1, String param2) {
        a_page31_10 fragment = new a_page31_10();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        databaseReference.orderByChild("study_category_low").equalTo("ERP/시스템분석/설계").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
