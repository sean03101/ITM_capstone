 ...
 */
public class a_page51_3 extends Fragment {
    ...
    public static a_page51_3 newInstance(String param1, String param2) {
        a_page51_3 fragment = new a_page51_3();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        databaseReference.orderByChild("study_category_low").equalTo("상품기획/MD").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
